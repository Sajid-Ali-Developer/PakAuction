          ...
          child: ListView(
            children: [
                   ...
                   child: Column(
                     children: [
                       Padding(
                        ...
                        child: Material(
                          child: Image.asset('Assets/Asset 1.png',width: 100,height: 100,),
                        ),
                       ),
                       Text('OnlineSystem',style: TextStyle(fontSize: 20.0,
              ...
              Container(
                ...
                child: Column(
                  children: [
                    Text('University of Engineering and Technology, Peshawar',style: TextStyle(fontSize: 10,fontWeight: FontWeight.bold,color: Colors.white),),
                    Row(
                      ...
                      children:[
                        ...
                        Text('sajidkhanbaloch880@gmail.com',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.white),),
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                ...
                children: [
                  ...
                  Center(
                    child: Container(
                      ...
                      child: RaisedButton(
                        padding: EdgeInsets.symmetric(vertical: 13, horizontal: 125),
                        onPressed: () {
          ...
          child: InkWell(
            onTap: () => {
              if(text =="Home" ){
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context) => CustomDrawableClass('this is my profile')))
              }
              else if(text == 'About Us'){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => CustomSettingclass('About Auction')))
                }
                else if(text == 'Help'){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => CustomHelpContactClass(this.text)))
                  }
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Row(
                    children: [
                      Icon(incondata,color: Colors.white,),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
