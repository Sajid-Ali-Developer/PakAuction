          ...
          Container(
            ...
            child: Expanded(
              child: GridView.count(
                ...
                children: <Widget>[
                  makeDashboardItem(
                      "Vehicles", Icons.directions_car_sharp, context),
                  makeDashboardItem("Machinary",
                      Icons.precision_manufacturing_outlined, context),
                  //makeDashboardItem("Building", Icons.house, context),
                  makeDashboardItem("Antiques", Icons.assistant, context),
                  makeDashboardItem("Electronic",
                      Icons.electrical_services_outlined, context),
                  makeDashboardItem("Sceneryies", Icons.image, context),
                  //makeDashboardItem("Watches", Icons.watch_outlined, context),
                  makeDashboardItem(
                      "Mix Auction", Icons.military_tech, context),
        ...
        child: new InkWell(
          onTap: () {
            if (title == 'Vehicles') {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => CustomDasboard()),
              );
