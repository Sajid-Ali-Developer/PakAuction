...
class _ExampleState extends State<Example> {
  List _locations = [
    ...
    'Complain',
    'Suggestion',
    'Requestion an Auction',
    'Deposit Refund',
    'Tech Support'
  ]; // Option 2
  String _selectedLocation; // Option 2
  final CameraPosition _initialcameraposition =
      CameraPosition(target: LatLng(34.025917, 71.560135));
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: DropdownButton(
                      hint: Text(
                          'Please choose any one'), // Not necessary for Option 1
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide:
                            new BorderSide(color: Colors.yellow, width: 5),
                      ),
                    ),
                  ),
                ),
