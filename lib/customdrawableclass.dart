      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Container(
              child: Text(text,style: TextStyle(fontSize: 25,color: Colors.black,decoration: TextDecoration.none),),
            ),
            //SizedBox(height: 20,),
            Container(
            ...
            Container(
              ...
              child: Column(
                children: [
                  Center(child: Text('Our Services',
